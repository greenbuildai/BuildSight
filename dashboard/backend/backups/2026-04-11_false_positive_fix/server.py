...
def run_inference(
    ...
    return raw, used_ensemble, audit_meta
...
async def detect_image(
    ...
    detections, used_ensemble, audit_meta = await run_in_threadpool(
    ...
    def _process() -> tuple[str, int, float]:
        ...
        while True:
            ...
            if frame_idx % sample_every == 0:
                raw, used, _ = run_inference(frame, condition, confidence, gemini_audit=use_gemini_audit)
