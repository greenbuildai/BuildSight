...
const DEMO_WORKERS: WorkerPosition[] = [
  { lat: 10.81665, lon: 78.66900, ppe_ok: false, has_helmet: false, has_vest: true,  zone: 'high_risk_scaffolding', risk: 'HIGH',     height_m: 5.2, worker_id: 1, status: 'AT_RISK',  dwell_time_s: 45, dwell_severity: 'LOW',  camera_id: 'CAM-01' },
  { lat: 10.81660, lon: 78.66885, ppe_ok: true,  has_helmet: true,  has_vest: true,  zone: 'moderate_risk_interior', risk: 'MODERATE', height_m: 1.8, worker_id: 2, status: 'SAFE',     dwell_time_s: 0,  dwell_severity: 'NONE', camera_id: 'CAM-01' },
  { lat: 10.81663, lon: 78.66892, ppe_ok: true,  has_helmet: true,  has_vest: true,  zone: 'moderate_risk_interior', risk: 'MODERATE', height_m: 2.1, worker_id: 3, status: 'SAFE',     dwell_time_s: 12, dwell_severity: 'NONE', camera_id: 'CAM-02' },
  { lat: 10.81667, lon: 78.66883, ppe_ok: false, has_helmet: true,  has_vest: false, zone: 'high_risk_staircase',    risk: 'CRITICAL', height_m: 5.8, worker_id: 4, status: 'CRITICAL', dwell_time_s: 85, dwell_severity: 'MEDIUM', camera_id: 'CAM-01' },
]
