...
description: Generates high-quality, predictable, and efficient agent skills based on user requirements. Use when the user asks to create a new skill or modify an existing one.
---
