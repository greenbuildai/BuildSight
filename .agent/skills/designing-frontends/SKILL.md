...
description: Acts as a frontend designer-engineer to create distinctive, production-grade interfaces. Use when the user requests frontend design, beautiful UIs, or intentional aesthetic guidance.
---
...
[x] Strong opinions, well executed
